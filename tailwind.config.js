  ...
  theme: {
    extend: {
      ...
      boxShadow: {
        ...
        'glow': '0 0 20px rgba(255, 80, 0, 0.3)',
      ...
      keyframes: {
        ...
        glowPulse: {
          '0%': { 'box-shadow': '0 0 20px rgba(255, 80, 0, 0.3)' },
          '100%': { 'box-shadow': '0 0 30px rgba(255, 80, 0, 0.6), 0 0 40px rgba(255, 80, 0, 0.4)' }
        },
        shake: {
      ...
      backgroundImage: {
        ...
        'gradient-ocean': 'linear-gradient(135deg, #667db6 0%, #0082c8 0%, #0082c8 0%, #667db6 100%)',
